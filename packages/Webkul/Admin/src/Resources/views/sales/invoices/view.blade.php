                ...
                <div class="bg-white rounded box-shadow dark:bg-gray-900">
                    ...
                    <div class="mt-4 flex w-full justify-end gap-2.5 p-4">
                        <div class="flex flex-col gap-y-1.5">
                            ...
                            <p class="!leading-5 text-base  font-semibold text-gray-600 dark:text-gray-300">
                                Due Amount
                            </p>
                        </div>
                        ...
                        <div class="flex flex-col gap-y-1.5">
                            ...
                            <p class="text-base font-semibold !leading-5 text-gray-800 dark:text-white">
                                {{ core()->formatBasePrice($invoice->base_grand_total - $order->base_grand_total_invoiced) }}
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <x-slot:header>
                        ...
                        <x-slot:content v-pre>
                            <div class="flex flex-col {{ $order->billing_address ? 'pb-4' : ''}}">
                                ...
                                <p class="text-gray-600 dark:text-gray-300">
                                    <!-- @lang('VAT', ['vat' => $invoice->order?->customer?->vat_id]) -->
                                    VAT/PAN Number : {{$invoice->order?->customer?->vat_id}}
                                </p>
